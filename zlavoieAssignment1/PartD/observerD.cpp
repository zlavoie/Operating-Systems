...
int main(int argc, char* argv[]){
 ...
 string  Info[6];
  ...
  //Start Part D Extension use command line arguments
  cout<<"                         PART D               "<<endl; 
  cout<<"******************************************************"<<endl;
  MemoryConfig();
  ...
  durations<<argv[3];
    ...
    cout<<"Jobs in run queue/waiting for disk I/O averaged over 1, 5, 15 minutes... \n"<<endl;
    cout<<"(Note: P/T is the column representing the numver of currently executing kernel scheduling entitites -- processes/threads. PID is the PID of the process that was most recently created on the system.) \n"<<endl;
    
    cout<<" 1  |  5 | 15 | P/T | PID"<<endl; 
    cout<<"---- ---- ---- ----- ----"<<endl;
